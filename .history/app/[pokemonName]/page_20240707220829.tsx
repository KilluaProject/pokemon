    ...
    <div className="container pt-20 mx-auto flex flex-col gap-10">
      ...
      <div className="flex mx-auto justify-center items-start w-full gap-10">
        ...
        <div className='flex flex-col gap-3'>
          ...
          <p className='font-normal'>{speciesData.flavor_text_entries.find((entry: any) => entry.language.name === 'en')?.flavor_text || 'No description available.'}</p>
          <h2 className='text-2xl'>Type Pokemon</h2>
