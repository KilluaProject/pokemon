...
const PokemonPage: React.FC<PokemonDetailProps> = ({ params }) => {
  ...
  if (!pokemonObject || !speciesData) {
    return <div>Loading...</div>;
  }

  const totalStats = pokemonObject.stats.reduce((accumulator: number, stat: any) => accumulator + stat.base_stat, 0);
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='max-w-2xl'>
            ...
            {pokemonObject.stats.map((statObject: any) => {
              ...
              // Ensure progress bar is 100% when base_stat is 100
              const statPercentage = statValue === 100 ? 100 : Math.round((statValue / totalStats) * 100);
              return (
                <div key={statName}>
