...
export default function PokemonPage({ params }: PokemonDetailProps) {
  ...
  const totalStats = pokemonObject?.stats.reduce((sum: number, stat: any) => sum + stat.base_stat, 0) || 0;
  const maxValue = 255;
  ...
  return (
    <div className="relative container pt-5 mx-auto flex flex-col gap-10 pb-10">
      ...
      <div className="md:flex flex-none mx-auto justify-center items-start w-full gap-10">
        <div className="border md:w-[40%] border-slate-200 p-4 rounded-md flex flex-col items-center justify-center bg-gray-100 h-[30rem mb-6]">
          <Image
