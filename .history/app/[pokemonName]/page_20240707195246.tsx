    ...
    <div className="container pt-20 mx-auto flex flex-col gap-10">
      ...
      <div className="flex mx-auto justify-center items-start w-full gap-10">
        ...
        <div className='flex flex-col gap-5'>
          ...
          <div>
                <div>
                  <p><span>base happiness </span>{speciesData.base_happiness}</p>
                  <p><span>capture rate </span>{speciesData.capture_rate}</p>
                  <p><span>growth rate </span>{speciesData.growth_rate.name}</p>
                </div>
          </div>
        </div>
      </div>
