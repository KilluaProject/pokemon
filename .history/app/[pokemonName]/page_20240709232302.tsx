...
export default async function PokemonPage({ params }: PokemonDetailProps) {
  ...
  const totalStats = pokemonObject.stats.reduce((acc: number, stat: any) => acc + stat.base_stat, 100);
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='max-w-2xl'>
            ...
            {pokemonObject.stats.map((statObject: any) => {
              ...
              const MAX_BASE_STAT = totalStats
              const statPercentage = totalStats ? Math.round((statValue / MAX_BASE_STAT) * 100) : 0;
