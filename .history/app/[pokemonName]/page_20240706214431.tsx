  ...
  return (
    <div className="container mx-auto flex flex-col gap-10">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="border border-slate-200 p-4 rounded-lg drop-shadow-lg flex flex-col items-center justify-center">
          <Image 
              ...
              return (
                <div>
                  <span 
                    ...
                    className="px-5 py-2 rounded-md text-white flex"
                  >
                    {type}
                  </span>
                </div>
