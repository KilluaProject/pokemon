...
export default async function PokemonPage({ params }: PokemonDetailProps) {
  ...
  const totalStats = pokemonObject.stats.reduce((acc: number, stat: any) => acc + stat.base_stat, 0);
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='max-w-2xl'>
            ...
            {pokemonObject.stats.map((statObject: any) => {
              ...
              const statPercentage = totalStats ? Math.round((statValue / MAX_BASE_STAT) * 100) : 100;
