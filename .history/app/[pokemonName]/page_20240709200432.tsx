...
export default async function PokemonPage({ params }: PokemonDetailProps) {
  ...
  const speciesResponse = await getPokemonSpecies(pokemonName)
    ...
    <div className="container pt-10 mx-auto flex flex-col gap-10">
      ...
      <div className="flex mx-auto justify-center items-start w-full gap-10">
        ...
        <div className='flex flex-col gap-3'>
          ...
          <p className='font-normal max-w-lg'>{speciesResponse.flavor_text_entries.find((entry: any) => entry.language.name === 'en')?.flavor_text || 'No description available.'}</p>
