...
// Tentukan nilai maksimum untuk setiap stat
const MAX_STATS = {
  hp: 255,
  attack: 190,
  defense: 230,
...
export default async function PokemonPage({ params }: PokemonDetailProps) {
  ...
  const calculatePercentage = (statName: string, statValue: number): number => {
    const maxStatValue = MAX_STATS[statName as keyof typeof MAX_STATS];
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div>
            ...
            {pokemonObject.stats.map((statObject: any) => {
              ...
              const percentage = calculatePercentage(statName, statValue);
