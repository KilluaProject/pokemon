        ...
        <div className='flex flex-col gap-3'>
          ...
          <div>
            ...
            {pokemonObject.stats.map((statObject: any) => {
                const getTotalBaseStat = {
                  return pokemonObject.stats.reduce((total: number, statObject: any) => {
                    return total + statObject.base_stat;
                  }, 0);
                };
              const statName = statObject.stat.name;
              const statValue = statObject.base_stat;
             
              console.log(getTotalBaseStat);
              ...
              return (
                <div key={statName}>
                  ...
                  <Progress value={getTotalBaseStat} />
                </div>
              );
            })}
          </div>
