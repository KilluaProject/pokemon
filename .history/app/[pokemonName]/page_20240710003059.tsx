        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='max-w-2xl'>
            ...
            {pokemonObject.stats.map((statObject: any) => {
              ...
              const statPercentage = totalStats ? Math.round((statValue / totalStats ) * 100) : 0;
              return (
                <div key={statName}>
                  <h3>{statName}: {statValue}</h3>
                  <Progress value={statPercentage} placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                </div>
              );
            })}
          </div>
