...
export function PokemonGrid({ pokemonList } : PokemonGridProps) {
        ...
        const [loadMore, setLoadMore] = useState("ttps://pokeapi.co/api/v2/pokemon?limit=151&offset=0")
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <button className="text-slate-100 rounded-lg px-3 py-1 bg-slate-900" onClick={() => getAllPokemon()}>Load More</button>
        </div>
