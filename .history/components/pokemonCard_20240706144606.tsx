...
export async function PokemonCard({ name } : PokemonCardProps) {
    ...
    return (
        <Link
          ...
          <Image src={`https://pokeapi.co/api/v2/pokemon/ditto#:~:text=%22https%3A//raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/132.png%22`}
          alt={name}
          width={20}
          height={20}/>
        </Link>
