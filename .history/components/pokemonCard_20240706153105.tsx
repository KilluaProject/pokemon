...
export async function PokemonCard({ name, pokemon }: PokemonCardProps) {
    ...
    return (
        <Link
          ...
          <Image
            src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/${pokemon}.png`}
            alt={name}
            width={200}
            height={200}
          />
